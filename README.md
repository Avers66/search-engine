...
Для скрытия шаблонного кода, геттеров, сеттеров, конструкторов и других стандартных методов используется библиотека Lombok (https://projectlombok.org) и соответствующие аннотации.
